...
Public Class CrpFornecedoress
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KanzenPTI.CrpFornecedoress.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpFornecedoress
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpFornecedoress = New CrpFornecedoress()
        rpt.Site = Me.Site
        Return rpt
    End Function
